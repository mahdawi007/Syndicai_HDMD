...
Original file is located at
    https://colab.research.google.com/drive/1c8VMYrKhFdqDfu99VKSJEwcawR468edA
"""
...
#        self.model = torch.hub.load('ultralytics/yolov5', 'yolov5s', pretrained=True).autoshape()
    ...
    def predict_iris(text):
        ...
        sample_annotated=[]
        for i in range(len(myresult['sentence'])):
            classifierTyp.predict(sample_sent[i])
        ...
        sample_annotated2=[]
        for i in range(len(myresult['sentence'])):
            classifierMis.predict(sample_sent[i])
